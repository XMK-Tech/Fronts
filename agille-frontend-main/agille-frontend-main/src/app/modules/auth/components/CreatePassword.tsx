    ...
    onSubmit: (values, {setStatus, setSubmitting}) => {
      ...
      changePassword(email, code, values.password)
        .then(() => {
          setHasErrors(false)
          setLoading(false)
          history.push('/auth/password-created')
        })
        .catch(() => {
          setHasErrors(true)
          setLoading(false)
    ...
    <>
      ...
      >
        <div className='text-center mb-10'>
          {/* begin::Title */}
          <h1 className='text-dark mb-3 fs-1'>Criar senha</h1>
          {/* end::Title */}
          <br />
          <br />
        ...
        <div className='fv-row mb-10'>
          <label className='form-label fw-bolder text-gray-900 fs-6'>Criar senha</label>
          <input
            type='password'
